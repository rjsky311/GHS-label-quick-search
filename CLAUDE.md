...
2. `PROJECT_STATUS_AND_NEXT_PLAN.md` - canonical current status, priority
...
10. `PRODUCT_SCOPE_GATE.md` - project-level "grill me" scope alignment for
   broad or ambiguous product decisions.
11. `FUTURE_PRODUCT_TODO_AFTER_PRINT_DEFERRAL.md` - active non-physical-print
   product tracker while real-printer validation is deferred.
12. `BATCH_LABEL_PRINT_REFACTOR_PLAN.md` - fixed-stock, purpose-first batch
