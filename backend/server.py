...
from api_validation import (
    ...
    MAX_CORRECTION_CANDIDATE_JSON_CHARS,
    ...
    _preferred_duplicate_reference_link,
...
api_router.include_router(
    create_pilot_admin_router(
        ...
        ensure_workspace_doc_type=_ensure_workspace_doc_type,
        pilot_store=pilot_store,
        app_version=APP_VERSION,
        ops_stale_threshold_hours=OPS_STALE_THRESHOLD_HOURS,
        ops_counters=ops_counters,
        cid_cache=cid_cache,
        ghs_cache=ghs_cache,
        ops_recent_events=ops_recent_events,
        is_dictionary_miss_capture_enabled=lambda: CAPTURE_DICTIONARY_MISSES,
        record_ops_counter=_record_ops_counter,
    )
)
