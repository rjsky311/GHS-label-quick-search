...
export default function PreviewDiagnosticsPanel({
  ...
  return (
    <details
      ...
      data-testid="preview-review-panel"
    >
      <summary className="flex cursor-pointer list-none items-start justify-between gap-3 text-sm font-semibold text-[hsl(var(--notebook-ink))]">
        <span className="flex min-w-0 items-start gap-2">
          <ClipboardList className="mt-0.5 h-4 w-4 shrink-0 text-[hsl(var(--notebook-action))]" />
          <span>
            <span className="block">
              {tx("label.previewReviewTitle", "Print review")}
            </span>
            <span className="mt-1 block text-xs font-normal leading-5 text-[hsl(var(--notebook-muted-ink))]">
              {tx(
                "label.previewReviewHint",
                "Output checks, readability notes, and sheet layout stay here after the label preview.",
              )}
            </span>
          </span>
        </span>
        <span className="flex shrink-0 flex-wrap justify-end gap-1.5">
          <span className="notebook-print-stage-fact rounded-full px-2 py-1 text-xs font-medium">
            {outputChecklistBadge}
          </span>
          <span className="notebook-print-stage-fact rounded-full px-2 py-1 text-xs font-medium">
      ...
      <div className="mt-3 space-y-3">
        ...
        >
          <div className="flex items-center justify-between gap-3 text-sm font-semibold text-[hsl(var(--notebook-ink))]">
          ...
          <div className="mt-3 flex flex-wrap gap-2 text-xs text-[hsl(var(--notebook-muted-ink))]">
            <span className="notebook-print-stage-fact rounded-full px-2 py-1">
