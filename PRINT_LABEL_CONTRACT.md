...
- Dense content must route users to a larger complete-label stock first, especially A4 Primary. Complete primary labels must block print until required content can be rendered and the responsible lab/supplier profile is complete.
