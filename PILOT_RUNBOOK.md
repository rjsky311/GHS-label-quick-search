...
| Production 502 or stale deploy | P0 production reliability | Use canonical health/build metadata; require `/build-info.json` git SHA proof before heavier production QA. |
